...
mgr.registerDemo("HelloWorld", "0.1.1-dev.21", v1_code_2);
mgr.registerDemo("Counter", "0.1.1-dev.21", v1_code_1);
mgr.registerDemo("TodoApp", "0.1.1-dev.21", v1_code_todoApp);
