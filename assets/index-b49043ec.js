...
mount("#app", App);
`,Cn=`import "https://cdn.skypack.dev/twind/shim";
...
`,j=new _n,de=e=>({"@rhjs/rh":`https://unpkg.com/@rhjs/rh@${e}/dist/main.module.mjs`});j.registerDemo({name:"HelloWorld",code:Ln,importMap:{...de("0.1.2")}});j.registerDemo({name:"Counter",code:jn,importMap:{...de("0.1.2")}});j.registerDemo({name:"TodoApp",code:On,importMap:{...de("0.1.2")}});const X=(e="latest",t="latest",n="latest")=>({"@rhjs/core":`https://unpkg.com/@rhjs/core@${e}/dist/main.module.mjs`,"@rhjs/builtin":`https://unpkg.com/@rhjs/builtin@${t}/dist/main.module.mjs`,"@rhjs/tag":`https://unpkg.com/@rhjs/tag@${n}/dist/main.module.mjs`});j.registerDemo({name:"Bitcoin",code:Sn,importMap:{...X("0.2.2","0.1.2","0.1.3")}});j.registerDemo({name:"Markdown Editor",code:Tn,importMap:{...X("0.2.2","0.1.2","0.1.3")}});j.registerDemo({name:"HTML tag",code:En,importMap:{...X("0.2.2","0.1.2","0.1.3")}});j.registerDemo({name:"twind",code:Cn,importMap:{...X("0.2.2","0.1.2","0.1.3")}});j.registerDemo({name:"atomic-css",code:Dn,importMap:{"@rhjs/atomic-css":"https://unpkg.com/@rhjs/atomic-css@latest/dist/main.module.mjs",...X("0.2.2","0.1.2","0.1.3")}});j.registerDemo({name:"Counter",code:Mn,importMap:{...de("0.0.34")}});const qe=M(j.currentDemo),yt=()=>({mgr:j,currentDemo:qe,selectDemo(e){qe.value=j.selectDemo(e)},demos:j.demos}),Rn=e=>{var n,o;const t=((n=e.importMap)==null?void 0:n["@rhjs/rh"])||((o=e.importMap)==null?void 0:o["@rhjs/core"]);if(t){const[,,s]=/@rhjs\/(rh|core)@(.+?)\//.exec(t)||[];if(s)return s}return"latest"},Nn=()=>{const{selectDemo:e,demos:t}=yt();return()=>y("div",null,y("select",{onChange:n=>e(n.target.value)},t.map(n=>y("option",{value:n.id},n.name," @",Rn(n)))))},je=({styleFn:e,isDark:t,...n},o,s)=>()=>y("div",{...n},y(q,{styleFn:()=>({height:"30px",display:"inline-flex",alignItems:"center",justifyContent:"center",paddingLeft:"12px",paddingRight:"12px",cursor:"pointer",userSelect:"none",marginLeft:"4px","&:hover":{backgroundColor:k(t)?"rgba(64,64,64,1)":"rgba(64,64,64,0.1)"},"&:active":{outline:"solid 1px",outlineColor:k(t)?"#fff":"rgba(64,64,64,1)"},...e==null?void 0:e()})}),s),An=({isDark:e})=>()=>y(je,{onClick:()=>{D(e)&&(e.value=!C(e))},isDark:e},y("span",null,()=>k(e)?"🌘":"🌖"));function Ge({isDark:e,href:t,target:n="_blank"},o,s){return()=>y(je,{isDark:e,onClick:()=>{window.open(t,n)}},y("a",{href:t,target:n,style:"text-decoration: none; color: inherit;"},s))}const zn=({isDark:e})=>()=>y("div",null,y(q,{styleFn:()=>({paddingLeft:"12px",paddingRight:"12px",height:"100%",width:"calc(100% - 24px)",display:"grid",gridTemplateColumns:"minmax(0, 1fr) 12px minmax(0, 1fr)"})}),y("div",{style:"display: inline-flex; align-items: center;"},y("span",{style:"user-select: none;word-break: keep-all;white-space: nowrap;"},"🧩 ",y("b",null,"R"),y("small",null,"eactive"),y("b",null,"H"),y("small",null,"ydrate"),y("b",null,"JS")," PLAYGROUND"),y(An,{isDark:e}),y(Nn,null)),y("div",null),y("div",{style:"display: inline-flex; align-items: center; justify-content: right;"},y(Ge,{isDark:e,href:"https://zhzluke96.github.io/rhjs-demos/#demo",target:"_self"},"demos"),y(Ge,{isDark:e,href:"https://github.com/zhzLuke96/rh.js"},"github"))),Pn=()=>document.querySelectorAll("iframe").forEach(e=>e.style.pointerEvents="none"),In=()=>document.querySelectorAll("iframe").forEach(e=>e.style.pointerEvents="auto"),Vn=({isHorizontal:e,onResize:t,ref:n})=>{const[o,s]=ln(!1),a=()=>s(!0),l=()=>s(!1),r=u=>{t(u.clientX,u.clientY)},i=u=>{const p=u.touches[0];t(p.clientX,p.clientY)},c=M(null);A(o,u=>{u?(Pn(),window.addEventListener("mousemove",r),window.addEventListener("mouseup",l),window.addEventListener("touchmove",i),window.addEventListener("touchend",l)):(In(),window.removeEventListener("mousemove",r),window.removeEventListener("mouseup",l),window.removeEventListener("touchmove",i),window.removeEventListener("touchend",l))}),A(c,u=>{u&&(u.addEventListener("mousedown",a,{passive:!0}),u.addEventListener("touchstart",a,{passive:!0}))}),L(()=>{var u,p;(u=k(c))==null||u.removeEventListener("mousedown",a),(p=k(c))==null||p.removeEventListener("touchstart",a)});const h=hn("isDark"),f=Qt(()=>k(h)?"rgba(255,255,255,0.3)":"rgba(0,0,0,0.3)");return()=>y("div",{ref:u=>{c.value=u,n&&(n.value=u)}},y(q,{styleFn:()=>({backgroundColor:k(o)?k(f):"",width:e?"100%":"12px",height:e?"12px":"100%",zIndex:k(o)?"10":"auto",cursor:e?"row-resize":"col-resize",userSelect:"none",display:"flex",justifyContent:"center",alignItems:"center",fontSize:"12px","&:hover":{backgroundColor:k(f)}})}),"⚪⚪⚪")},$n=()=>{const e=`
<!DOCTYPE html>
<html lang="en">
  <meta charset="utf-8" />
...
`.trim(),t=URL.createObjectURL(new Blob([e],{type:"text/html"}));return L(()=>URL.revokeObjectURL(t)),`${t}#?embedded=${encodeURIComponent(location.origin)}`},Un=(e,t,n="")=>`
<!doctype html>
<html${e?' class="dark"':""}>
  <head>
    <meta charset="UTF-8" />
...
`.trim(),Hn=(e,t,n,o)=>{const s={sendToIframe(r){var i,c;(c=(i=C(e))==null?void 0:i.contentWindow)==null||c.postMessage(r,"*")},sendToDevtools(r){var i,c;(c=(i=C(t))==null?void 0:i.contentWindow)==null||c.postMessage(r,"*")}},a=()=>{const{codeInjected:r,codeURL:i}=k(n);if(!r){if(!i){setTimeout(a,3);return}requestAnimationFrame(()=>{s.sendToIframe({event:"CODE_UPDATE",value:i}),o({type:"CODE_INJECTED"})})}},l=r=>{var h,f;const[i,c]=vt(e,t);!i||!c||((f=(h=r.data)==null?void 0:h.includes)!=null&&f.call(h,"Debugger.enable")&&(console.log("Debugger.enable"),o({type:"Debugger.enable"}),a()),r.source===i.contentWindow?c.contentWindow.postMessage(r.data,"*"):r.source===c.contentWindow&&i.contentWindow.postMessage({event:"DEV",data:r.data},"*"))};return window.addEventListener("message",l),L(()=>window.removeEventListener("message",l)),s},Fn=(e,t)=>{const{importMap:n,isDark:o}=e,s=De(()=>{const a=Un(C(o),JSON.stringify({imports:k(n)}));return URL.createObjectURL(new Blob([a],{type:"text/html"}))});return A(s,(a,l)=>{l!==a&&l&&URL.revokeObjectURL(l),t({type:"HTML_CHANGED",iframeSrc:a||""})}),L(()=>{URL.revokeObjectURL(C(s)||"")}),{iframeSrc:s}},Wn=e=>{const{isDark:t,code:n}=e,o=ge(null),s=ge(null),a=d=>{var m;return(m=d.contentDocument)==null?void 0:m.documentElement.classList.toggle("dark",C(t))},l=d=>{const m=C(o);m&&(m.src=d)},r=()=>{var d,m;(m=(d=C(o))==null?void 0:d.contentWindow)==null||m.location.reload()},i=()=>{var d,m;(m=(d=C(s))==null?void 0:d.contentWindow)==null||m.location.reload()};A(()=>k(t),d=>{const m=k(o);m&&a(m)});const[c,h]=dn((d,m)=>{switch(m.type){case"IFRAME_READY":a(m.iframe);let w=d.codeInjected;return{...d,codeInjected:w,iframeReady:!0};case"DEVTOOLS_IFRAME_READY":return{...d,devtoolsIframeReady:!0};case"DEV_LOADED":return{...d,devLoaded:!0};case"HTML_CHANGED":return l(m.iframeSrc),i(),{...d,iframeReady:!1,devtoolsIframeReady:!1,devLoaded:!1,codeInjected:!1,darkInjected:!1};case"HTML_RELOAD":return setTimeout(()=>{r(),i()}),{...d,iframeReady:!1,devtoolsIframeReady:!1,devLoaded:!1,codeInjected:!1,darkInjected:!1};case"CODE_UPDATE":return{...d,codeURL:m.codeURL};case"CODE_INJECTED":return{...d,codeInjected:!0}}return d},{iframeReady:!1,devtoolsIframeReady:!1,devLoaded:!1,codeInjected:!1,codeURL:C(n)}),{sendToDevtools:f,sendToIframe:u}=Hn(o,s,c,h);A(()=>k(n),d=>{h({type:"CODE_UPDATE",codeURL:d}),c.value.iframeReady&&requestAnimationFrame(()=>{u({event:"CODE_UPDATE",value:d}),h({type:"CODE_INJECTED"})})});const{iframeSrc:p}=Fn(e,h);return A(o,d=>{d==null||d.addEventListener("load",()=>h({type:"IFRAME_READY",iframe:d}))}),A(s,d=>{d==null||d.addEventListener("load",()=>h({type:"DEVTOOLS_IFRAME_READY",devIframe:d}))}),{iframeSrc:p,iframeRef:o,devtoolsIframeRef:s,previewState:c,dispatch:h,sendToDevtools:f,sendToIframe:u}},Bn=e=>{const{importMap:t,code:n,devtools:o,isDark:s,...a}=e,l=M(null),{iframeSrc:r,iframeRef:i,devtoolsIframeRef:c,previewState:h,dispatch:f}=Wn(e),u=$n(),p=De(()=>`width: 100%; height: 100%; ${k(o)?"display: block;":"display: none;"}`),d=M(.625),m=M(null),w=(g,b)=>{const[S,T]=vt(l,m);if(!S||!T)return;let E,_;const W=S.getBoundingClientRect();E=b-W.top-T.offsetHeight/2,_=S.offsetHeight-T.offsetHeight;const wt=E/_;d.value=wt};return()=>y("div",{...a,ref:l},y(q,{styleFn:()=>{const g=k(d);return{display:"grid",height:"100%",width:"100%",gridTemplateRows:k(o)?`30px minmax(0, ${g}fr) 12px minmax(0, ${1-g}fr)`:"30px minmax(0, 1fr)"}}}),y("div",{style:"border-bottom: 1px solid;border-top: 1px solid;overflow: hidden;"},y(je,{title:"reload page",isDark:s,onClick:()=>f({type:"HTML_RELOAD"})},"♻️relaod")),y("iframe",{ref:i,src:r,style:"width: 100%;height: 100%;",frameBorder:0,sandbox:"allow-popups-to-escape-sandbox allow-scripts allow-popups allow-forms allow-pointer-lock allow-top-navigation allow-modals allow-same-origin"}),y("div",null,y(Vn,{ref:m,isHorizontal:!0,onResize:w})),y("iframe",{ref:c,style:p,src:u,frameBorder:"0"}))},qn=({isDark:e})=>()=>y(xn,{styleFn:()=>({fontFamily:"'Karla', system-ui, -apple-system, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji'",lineHeight:"1.5",fontWeight:"400",colorScheme:k(e)?"light dark":"dark",color:k(e)?"rgba(255, 255, 255, 0.87)":"#242424",backgroundColor:k(e)?"#333":"#fff",fontSynthesis:"none",textRendering:"optimizeLegibility","-webkitFontSmoothing":"antialiased","-moz-osxFontSmoothing":"grayscale","-webkitTextSizeAdjust":"100%",height:"100vh",width:"100vw",body:{margin:"0",minWidth:"100vw",minHeight:"100vh",width:"100%",height:"100%"},"#app":{width:"100%",height:"100%"}})});function Gn(){return new Worker(""+new URL("complier.worker-026b4f92.js",import.meta.url).href)}class Yn{constructor(){B(this,"registry",{})}registerWorker(t,n){this.registry[t]?console.warn(`Worker of type ${t} already registered.`):this.registry[t]=n}removeWorker(t){delete this.registry[t]}getWorker(t){const n=this.registry[t];if(n)return n;throw new Error(`No worker of type ${t} registered.`)}postMessage(t,n){this.getWorker(t).postMessage(n)}listenRecv(t,n){const o=this.getWorker(t);let s;const a=l=>{const{message_token:r}=l.data||{};if(r!==n)return;const i={...l.data};delete i.message_token,s(i),o.removeEventListener("message",a)};return o.addEventListener("message",a),{recv:new Promise((l,r)=>{s=l}),dispose:()=>o.removeEventListener("message",a)}}}class Zn{constructor(){B(this,"registry",new Yn);this.initialize()}async initialize(){this.registry.registerWorker("complier",new Gn)}worker_caller(t,n){const o=Math.random().toString(36).slice(2),s={...n,message_token:o};return this.registry.postMessage(t,s),this.registry.listenRecv(t,o)}compileFile(t){return this.worker_caller("complier",{event:"BABEL",payload:{file:t,compile_options:{}}})}compileFiles(t){return this.worker_caller("complier",{event:"ROLLUP",payload:{files:t,compile_options:{}}})}}const Ye=new Zn,Qn=()=>{let e=null;return L(()=>e==null?void 0:e.dispose()),{compileFile(t){return e==null||e.dispose(),e=Ye.compileFile(t),e.recv},compileFiles(t){return e==null||e.dispose(),e=Ye.compileFiles(t),e.recv}}},Kn='import("@rhjs/rh").then(({cs, ElementSource, View}) => window.dispose = () => View ? View.globalView.unmount() : (cs || ElementSource).global_source.emit("unmount"));',Jn=()=>{var i;const e=M(!0);un("isDark",e);const{currentDemo:t}=yt(),n=De(()=>{var c;return{"@rhjs/rh":"https://unpkg.com/@rhjs/rh@latest/dist/main.module.mjs","@rhjs/fluent-web-components":"https://unpkg.com/@rhjs/fluent-web-components@latest/dist/main.module.mjs",...(c=t.value)==null?void 0:c.importMap}}),o=M(""),s=fn(o,{type:"text/javascript"}),a=M(((i=t.value)==null?void 0:i.code)||""),l=Qn(),r=async()=>{const c=C(a);if(!c)return;const h=await l.compileFile({filename:"main.tsx",source:c});o.value=`${h.compiled}
${Kn}`};return ft(r),A(t,c=>{c&&a.value!==c.code&&(a.value=c.code,r())}),()=>y("div",null,y(qn,{isDark:e}),y(q,{styleFn:()=>({position:"relative",display:"flex",flexFlow:"column",width:"100%",height:"100%",maxWidth:"100vw",maxHeight:"100vh",overflow:"hidden"})}),y("header",{style:"height: 30px; width: 100%;"},y(zn,{isDark:e})),y("div",{style:"flex: 1;"},y(q,{styleFn:()=>({position:"relative",display:"flex",flexFlow:"row",width:"100%",height:"100%"})}),y(wn,{style:"flex: 1;",value:a,onChange:c=>a.value=c,onSave:r,isDark:e}),y(Bn,{style:"flex: 1;",importMap:n,code:s,devtools:!0,isDark:e})))};on("#app",Jn);
