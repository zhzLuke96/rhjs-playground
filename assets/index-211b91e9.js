...
mount("#app", App);
`,Nt=`import { rh, ref, mount, unref, computed, onUnmounted } from "@rhjs/core";
...
mount("#app", App);
`,Pt=`import { mount, createState } from "@rhjs/core";
// @ts-ignore
...
mount("#app", App);
`,Vt=`import "https://cdn.skypack.dev/twind/shim";
...
mount("#app", App);
`,It=`import { rh, mount } from "@rhjs/core";
import { Scope } from "@rhjs/builtin";
// @ts-ignore
import { html } from "@rhjs/tag";
// @ts-ignore
...
mount("#app", App);
`,$t=`import { rh, ref, mount, unref, setupWatch, inject, provide } from "@rhjs/rh";
...
mount("#app", App);
`,zt=`import { rh, ref, mount, unref, computed, onUnmount } from "@rhjs/rh";
...
mount("#app", TodoApp);
`,Ft=`import { Button, ensureFluentUILoaded } from "@rhjs/fluent-web-components";
...
`,j=new Rt,fe=n=>({"@rhjs/rh":`https://unpkg.com/@rhjs/rh@${n}/dist/main.module.mjs`}),Ht=(n,e)=>`https://unpkg.com/${n}@${e}/dist/main.module.mjs`,Wt=n=>Object.fromEntries(Object.entries(n).map(([e,t])=>[e,Ht(e,t)])),Sn=({core:n,hooks:e,builtin:t,tag:o,hyper:s,atomic:r}={})=>Wt({"@rhjs/core":n||"latest","@rhjs/hooks":e||"latest","@rhjs/builtin":t||"latest","@rhjs/tag":o||"latest","@rhjs/hyper":s||"latest","@rhjs/atomic-css":r||"latest"});j.registerDemo({name:"Calculator Jsx (v3 hyper mode)",code:Lt,importMap:{...Sn()}});j.registerDemo({name:"Calculator (v3 hyper mode)",code:Ot,importMap:{...Sn()}});const Y=(n="latest",e="latest",t="latest")=>({"@rhjs/core":`https://unpkg.com/@rhjs/core@${n}/dist/main.module.mjs`,"@rhjs/builtin":`https://unpkg.com/@rhjs/builtin@${e}/dist/main.module.mjs`,"@rhjs/tag":`https://unpkg.com/@rhjs/tag@${t}/dist/main.module.mjs`});j.registerDemo({name:"Hello World",code:Nt,importMap:{...Y("0.2.5","0.1.3","0.1.6")}});j.registerDemo({name:"Bitcoin",code:Mt,importMap:{...Y("0.2.5","0.1.3","0.1.6")}});j.registerDemo({name:"Markdown Editor",code:At,importMap:{...Y("0.2.5","0.1.3","0.1.6")}});j.registerDemo({name:"HTML tag",code:Pt,importMap:{...Y("0.2.5","0.1.3","0.1.6")}});j.registerDemo({name:"twind",code:Vt,importMap:{...Y("0.2.5","0.1.3","0.1.6")}});j.registerDemo({name:"atomic-css",code:It,importMap:{"@rhjs/atomic-css":"https://unpkg.com/@rhjs/atomic-css@latest/dist/main.module.mjs",...Y("0.2.5","0.1.3","0.1.6")}});j.registerDemo({name:"HelloWorld",code:zt,importMap:{...fe("0.1.2")}});j.registerDemo({name:"Counter",code:$t,importMap:{...fe("0.1.2")}});j.registerDemo({name:"TodoApp",code:Ut,importMap:{...fe("0.1.2")}});j.registerDemo({name:"Counter",code:Ft,importMap:{...fe("0.0.34")}});const Je=O(j.currentDemo),Cn=()=>({mgr:j,currentDemo:Je,selectDemo(n){Je.value=j.selectDemo(n)},demos:j.demos}),Bt=n=>{var t,o;const e=((t=n.importMap)==null?void 0:t["@rhjs/rh"])||((o=n.importMap)==null?void 0:o["@rhjs/core"]);if(e){const[,,s]=/@rhjs\/(rh|core)@(.+?)\//.exec(e)||[];if(s)return s}return"latest"},qt=()=>{const{selectDemo:n,demos:e}=Cn();return()=>w("div",null,w("select",{onChange:t=>n(t.target.value)},e.map(t=>w("option",{value:t.id},t.name," @",Bt(t)))))},Ne=({styleFn:n,isDark:e,...t},o,s)=>()=>w("div",{...t},w(G,{styleFn:()=>({height:"30px",display:"inline-flex",alignItems:"center",justifyContent:"center",paddingLeft:"12px",paddingRight:"12px",cursor:"pointer",userSelect:"none",marginLeft:"4px","&:hover":{backgroundColor:x(e)?"rgba(64,64,64,1)":"rgba(64,64,64,0.1)"},"&:active":{outline:"solid 1px",outlineColor:x(e)?"#fff":"rgba(64,64,64,1)"},...n==null?void 0:n()})}),s),Gt=({isDark:n})=>()=>w(Ne,{onClick:()=>{R(n)&&(n.value=!T(n))},isDark:n},w("span",null,()=>x(n)?"🌘":"🌖"));function Yt({isDark:n,href:e,target:t="_blank"},o,s){return()=>w(Ne,{isDark:n,onClick:()=>{window.open(e,t)}},w("a",{href:e,target:t,style:"text-decoration: none; color: inherit;"},s))}const Zt=({isDark:n})=>()=>w("div",null,w(G,{styleFn:()=>({paddingLeft:"12px",paddingRight:"12px",height:"100%",width:"calc(100% - 24px)",display:"grid",gridTemplateColumns:"minmax(0, 1fr) 12px minmax(0, 1fr)"})}),w("div",{style:"display: inline-flex; align-items: center;"},w("span",{style:"user-select: none;word-break: keep-all;white-space: nowrap;"},"🧩 ",w("b",null,"R"),w("small",null,"eactive"),w("b",null,"H"),w("small",null,"ydrate"),w("b",null,"JS")," PLAYGROUND"),w(Gt,{isDark:n}),w(qt,null)),w("div",null),w("div",{style:"display: inline-flex; align-items: center; justify-content: right;"},w(Yt,{isDark:n,href:"https://github.com/zhzLuke96/rh.js"},"🐱‍👤Github"))),Jt=()=>document.querySelectorAll("iframe").forEach(n=>n.style.pointerEvents="none"),Qt=()=>document.querySelectorAll("iframe").forEach(n=>n.style.pointerEvents="auto"),Kt=({isHorizontal:n,onResize:e,ref:t})=>{const[o,s]=vt(!1),r=()=>s(!0),l=()=>s(!1),i=u=>{e(u.clientX,u.clientY)},h=u=>{const a=u.touches[0];e(a.clientX,a.clientY)},c=O(null);V(o,u=>{u?(Jt(),window.addEventListener("mousemove",i),window.addEventListener("mouseup",l),window.addEventListener("touchmove",h),window.addEventListener("touchend",l)):(Qt(),window.removeEventListener("mousemove",i),window.removeEventListener("mouseup",l),window.removeEventListener("touchmove",h),window.removeEventListener("touchend",l))}),V(c,u=>{u&&(u.addEventListener("mousedown",r,{passive:!0}),u.addEventListener("touchstart",r,{passive:!0}))}),L(()=>{var u,a;(u=x(c))==null||u.removeEventListener("mousedown",r),(a=x(c))==null||a.removeEventListener("touchstart",r)});const p=wt("isDark",void 0),y=tt(()=>x(p)?"rgba(255,255,255,0.3)":"rgba(0,0,0,0.3)");return()=>w("div",{ref:u=>{c.value=u,t&&(t.value=u)}},w(G,{styleFn:()=>({backgroundColor:x(o)?x(y):"",width:n?"100%":"12px",height:n?"12px":"100%",zIndex:x(o)?"10":"auto",cursor:n?"row-resize":"col-resize",userSelect:"none",display:"flex",justifyContent:"center",alignItems:"center",fontSize:"12px","&:hover":{backgroundColor:x(y)}})}),"⚪⚪⚪")},Xt=()=>{const n=`
<!DOCTYPE html>
<html lang="en">
  <meta charset="utf-8" />
...
`.trim(),e=URL.createObjectURL(new Blob([n],{type:"text/html"}));return L(()=>URL.revokeObjectURL(e)),`${e}#?embedded=${encodeURIComponent(location.origin)}`},eo=(n,e,t="")=>`
<!doctype html>
<html${n?' class="dark"':""}>
  <head>
    <meta charset="UTF-8" />
...
`.trim(),no=(n,e,t,o)=>{const s={sendToIframe(i){var h,c;(c=(h=T(n))==null?void 0:h.contentWindow)==null||c.postMessage(i,"*")},sendToDevtools(i){var h,c;(c=(h=T(e))==null?void 0:h.contentWindow)==null||c.postMessage(i,"*")}},r=()=>{const{codeInjected:i,codeURL:h}=x(t);if(!i){if(!h){setTimeout(r,3);return}requestAnimationFrame(()=>{s.sendToIframe({event:"CODE_UPDATE",value:h}),o({type:"CODE_INJECTED"})})}},l=i=>{var p,y;const[h,c]=xn(n,e);!h||!c||((y=(p=i.data)==null?void 0:p.includes)!=null&&y.call(p,"Debugger.enable")&&(console.log("Debugger.enable"),o({type:"Debugger.enable"}),r()),i.source===h.contentWindow?c.contentWindow.postMessage(i.data,"*"):i.source===c.contentWindow&&h.contentWindow.postMessage({event:"DEV",data:i.data},"*"))};return window.addEventListener("message",l),L(()=>window.removeEventListener("message",l)),s},to=(n,e)=>{const{importMap:t,isDark:o}=n,s=Oe(()=>{const r=eo(T(o),JSON.stringify({imports:x(t)}));return URL.createObjectURL(new Blob([r],{type:"text/html"}))});return V(s,(r,l)=>{l!==r&&l&&URL.revokeObjectURL(l),e({type:"HTML_CHANGED",iframeSrc:r||""})}),L(()=>{URL.revokeObjectURL(T(s)||"")}),{iframeSrc:s}},oo=n=>{const{isDark:e,code:t}=n,o=ke(null),s=ke(null),r=d=>{var m;return(m=d.contentDocument)==null?void 0:m.documentElement.classList.toggle("dark",T(e))},l=d=>{const m=T(o);m&&(m.src=d)},i=()=>{var d,m;(m=(d=T(o))==null?void 0:d.contentWindow)==null||m.location.reload()},h=()=>{var d,m;(m=(d=T(s))==null?void 0:d.contentWindow)==null||m.location.reload()};V(()=>x(e),d=>{const m=x(o);m&&r(m)});const[c,p]=gt((d,m)=>{switch(m.type){case"IFRAME_READY":r(m.iframe);let g=d.codeInjected;return{...d,codeInjected:g,iframeReady:!0};case"DEVTOOLS_IFRAME_READY":return{...d,devtoolsIframeReady:!0};case"DEV_LOADED":return{...d,devLoaded:!0};case"HTML_CHANGED":return l(m.iframeSrc),h(),{...d,iframeReady:!1,devtoolsIframeReady:!1,devLoaded:!1,codeInjected:!1,darkInjected:!1};case"HTML_RELOAD":return setTimeout(()=>{i(),h()}),{...d,iframeReady:!1,devtoolsIframeReady:!1,devLoaded:!1,codeInjected:!1,darkInjected:!1};case"CODE_UPDATE":return{...d,codeURL:m.codeURL};case"CODE_INJECTED":return{...d,codeInjected:!0}}return d},{iframeReady:!1,devtoolsIframeReady:!1,devLoaded:!1,codeInjected:!1,codeURL:T(t)}),{sendToDevtools:y,sendToIframe:u}=no(o,s,c,p);V(()=>x(t),d=>{p({type:"CODE_UPDATE",codeURL:d}),c.value.iframeReady&&requestAnimationFrame(()=>{u({event:"CODE_UPDATE",value:d}),p({type:"CODE_INJECTED"})})});const{iframeSrc:a}=to(n,p);return V(o,d=>{d==null||d.addEventListener("load",()=>p({type:"IFRAME_READY",iframe:d}))}),V(s,d=>{d==null||d.addEventListener("load",()=>p({type:"DEVTOOLS_IFRAME_READY",devIframe:d}))}),{iframeSrc:a,iframeRef:o,devtoolsIframeRef:s,previewState:c,dispatch:p,sendToDevtools:y,sendToIframe:u}},so=n=>{const{importMap:e,code:t,devtools:o,isDark:s,...r}=n,l=O(null),{iframeSrc:i,iframeRef:h,devtoolsIframeRef:c,previewState:p,dispatch:y}=oo(n),u=Xt(),a=Oe(()=>`width: 100%; height: 100%; ${x(o)?"display: block;":"display: none;"}`),d=O(.625),m=O(null),g=(f,b)=>{const[C,_]=xn(l,m);if(!C||!_)return;let E,S;const W=C.getBoundingClientRect();E=b-W.top-_.offsetHeight/2,S=C.offsetHeight-_.offsetHeight;const En=E/S;d.value=En};return()=>w("div",{...r,ref:l},w(G,{styleFn:()=>{const f=x(d);return{display:"grid",height:"100%",width:"100%",gridTemplateRows:x(o)?`30px minmax(0, ${f}fr) 12px minmax(0, ${1-f}fr)`:"30px minmax(0, 1fr)"}}}),w("div",{style:"border-bottom: 1px solid;border-top: 1px solid;overflow: hidden;"},w(Ne,{title:"reload page",isDark:s,onClick:()=>y({type:"HTML_RELOAD"})},"♻️relaod")),w("iframe",{ref:h,src:i,style:"width: 100%;height: 100%;",frameBorder:0,sandbox:"allow-popups-to-escape-sandbox allow-scripts allow-popups allow-forms allow-pointer-lock allow-top-navigation allow-modals allow-same-origin"}),w("div",null,w(Kt,{ref:m,isHorizontal:!0,onResize:g})),w("iframe",{ref:c,style:a,src:u,frameBorder:"0"}))},ro=({isDark:n})=>()=>w(Dt,{styleFn:()=>({fontFamily:"'Karla', system-ui, -apple-system, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji'",lineHeight:"1.5",fontWeight:"400",colorScheme:x(n)?"light dark":"dark",color:x(n)?"rgba(255, 255, 255, 0.87)":"#242424",backgroundColor:x(n)?"#333":"#fff",fontSynthesis:"none",textRendering:"optimizeLegibility","-webkitFontSmoothing":"antialiased","-moz-osxFontSmoothing":"grayscale","-webkitTextSizeAdjust":"100%",height:"100vh",width:"100vw",body:{margin:"0",minWidth:"100vw",minHeight:"100vh",width:"100%",height:"100%"},"#app":{width:"100%",height:"100%"}})});function io(){return new Worker(""+new URL("complier.worker-7f92b747.js",import.meta.url).href)}class ao{constructor(){B(this,"registry",{})}registerWorker(e,t){this.registry[e]?console.warn(`Worker of type ${e} already registered.`):this.registry[e]=t}removeWorker(e){delete this.registry[e]}getWorker(e){const t=this.registry[e];if(t)return t;throw new Error(`No worker of type ${e} registered.`)}postMessage(e,t){this.getWorker(e).postMessage(t)}listenRecv(e,t){const o=this.getWorker(e);let s;const r=l=>{const{message_token:i}=l.data||{};if(i!==t)return;const h={...l.data};delete h.message_token,s(h),o.removeEventListener("message",r)};return o.addEventListener("message",r),{recv:new Promise((l,i)=>{s=l}),dispose:()=>o.removeEventListener("message",r)}}}class co{constructor(){B(this,"registry",new ao);this.initialize()}async initialize(){this.registry.registerWorker("complier",new io)}worker_caller(e,t){const o=Math.random().toString(36).slice(2),s={...t,message_token:o};return this.registry.postMessage(e,s),this.registry.listenRecv(e,o)}compileFile(e){return this.worker_caller("complier",{event:"BABEL",payload:{file:e,compile_options:{}}})}compileFiles(e){return this.worker_caller("complier",{event:"ROLLUP",payload:{files:e,compile_options:{}}})}}const Qe=new co,lo=()=>{let n=null;return L(()=>n==null?void 0:n.dispose()),{compileFile(e){return n==null||n.dispose(),n=Qe.compileFile(e),n.recv},compileFiles(e){return n==null||n.dispose(),n=Qe.compileFiles(e),n.recv}}},uo='import("@rhjs/rh").then(({cs, ElementSource, View}) => window.dispose = () => View ? View.globalView.unmount() : (cs || ElementSource).global_source.emit("unmount"));',ho=()=>{var h;const n=O(!0);yt("isDark",n);const{currentDemo:e}=Cn(),t=Oe(()=>{var c;return{"@rhjs/rh":"https://unpkg.com/@rhjs/rh@latest/dist/main.module.mjs","@rhjs/fluent-web-components":"https://unpkg.com/@rhjs/fluent-web-components@latest/dist/main.module.mjs",...(c=e.value)==null?void 0:c.importMap}}),o=O(""),s=kt(o,{type:"text/javascript"}),r=O(((h=e.value)==null?void 0:h.code)||""),l=lo(),i=async()=>{const c=T(r);if(!c)return;const p=await l.compileFile({filename:"main.tsx",source:c});o.value=`${p.compiled}
${uo}`};return kn(i),V(e,c=>{c&&r.value!==c.code&&(r.value=c.code,i())}),()=>w("div",null,w(ro,{isDark:n}),w(G,{styleFn:()=>({position:"relative",display:"flex",flexFlow:"column",width:"100%",height:"100%",maxWidth:"100vw",maxHeight:"100vh",overflow:"hidden"})}),w("header",{style:"height: 30px; width: 100%;"},w(Zt,{isDark:n})),w("div",{style:"flex: 1;"},w(G,{styleFn:()=>({position:"relative",display:"flex",flexFlow:"row",width:"100%",height:"100%"})}),w(Et,{style:"flex: 1;",value:r,onChange:c=>r.value=c,onSave:i,isDark:n}),w(so,{style:"flex: 1;",importMap:t,code:s,devtools:!0,isDark:n})))};ut("#app",ho);
