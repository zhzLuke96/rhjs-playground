...
`,V=new fn;V.registerDemo("HelloWorld","0.1.1-dev.9",mn);V.registerDemo("Counter","0.1.1-dev.9",pn);V.registerDemo("Counter","0.0.34",vn);const We=O(V.currentDemo),vt=()=>({mgr:V,currentDemo:We,selectDemo(e){We.value=V.selectDemo(e)},demos:V.demos}),gn=()=>{const{selectDemo:e,currentDemo:t,demos:n}=vt();return()=>f("div",null,f("select",{onChange:r=>e(r.target.value)},n.map(r=>f("option",{value:r.id},r.name," @",r.version))))},gt=({styleFn:e,isDark:t,...n},r,o)=>()=>f("div",{...n},f($.Style,{styleFn:()=>({display:"inline-flex",alignItems:"center",justifyContent:"center",paddingLeft:"12px",paddingRight:"12px",cursor:"pointer",userSelect:"none",marginLeft:"4px","&:hover":{backgroundColor:y(t)?"rgba(64,64,64,1)":"rgba(64,64,64,0.1)"},"&:active":{outline:"solid 1px",outlineColor:y(t)?"#fff":"rgba(64,64,64,1)"},...e==null?void 0:e()})}),o),_n=({isDark:e})=>()=>f(gt,{onClick:()=>{k(e)&&(e.value=!S(e))},isDark:e},f("span",null,()=>y(e)?"🌘":"🌖")),Fe=({isDark:e,href:t,target:n="_blank"},r,o)=>()=>f(gt,{isDark:e,onClick:()=>{window.open(t,n)}},f("a",{href:t,target:n,style:"text-decoration: none; color: inherit;"},o)),yn=({isDark:e})=>()=>f("div",null,f($.Style,{styleFn:()=>({paddingLeft:"12px",paddingRight:"12px",height:"100%",width:"calc(100% - 24px)",display:"grid",gridTemplateColumns:"minmax(0, 1fr) 12px minmax(0, 1fr)"})}),f("div",{style:"display: inline-flex; align-items: center;"},f("span",{style:"user-select: none;"},"🧩 ",f("b",null,"R"),f("small",null,"eactive"),f("b",null,"H"),f("small",null,"ydrate"),f("b",null,"JS")," PLAYGROUND"),f(_n,{isDark:e}),f(gn,null)),f("div",null),f("div",{style:"display: inline-flex; align-items: center; justify-content: right;"},f(Fe,{isDark:e,href:"https://zhzluke96.github.io/rhjs-demos/#demo",target:"_self"},"demos"),f(Fe,{isDark:e,href:"https://github.com/zhzLuke96/rh.js"},"github"))),{Style:wn}=$,bn=()=>document.querySelectorAll("iframe").forEach(e=>e.style.pointerEvents="none"),En=()=>document.querySelectorAll("iframe").forEach(e=>e.style.pointerEvents="auto"),Sn=({isHorizontal:e,onResize:t,ref:n})=>{const[r,o,s]=nn(!1),i=()=>o(!0),c=()=>o(!1),a=h=>{t(h.clientX,h.clientY)},l=h=>{const d=h.touches[0];t(d.clientX,d.clientY)},u=O(null);return j(s,h=>{h?(bn(),window.addEventListener("mousemove",a),window.addEventListener("mouseup",c),window.addEventListener("touchmove",l),window.addEventListener("touchend",c)):(En(),window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",c),window.removeEventListener("touchmove",l),window.removeEventListener("touchend",c))}),j(u,h=>{h&&(h.addEventListener("mousedown",i,{passive:!0}),h.addEventListener("touchstart",i,{passive:!0}))}),C(()=>{var h,d;(h=y(u))==null||h.removeEventListener("mousedown",i),(d=y(u))==null||d.removeEventListener("touchstart",i)}),()=>f("div",{ref:h=>{u.value=h,n&&(n.value=h)}},f(wn,{styleFn:()=>({backgroundColor:y(s)?"rgba(255,255,255,0.3)":"",width:e?"100%":"12px",height:e?"12px":"100%",zIndex:y(s)?"10":"auto",cursor:e?"row-resize":"col-resize",userSelect:"none",display:"flex",justifyContent:"center",alignItems:"center",fontSize:"12px","&:hover":{backgroundColor:"rgba(255,255,255,0.3)"}})}),"⚪⚪⚪")},Cn=()=>{const e=`
<!DOCTYPE html>
<html lang="en">
  <meta charset="utf-8" />
